...
typedef struct __mavlink_optical_flow_t
{
 ...
 float flow_comp_x; /*< Flow in x-sensor direction, angular-speed compensated*/
 float flow_comp_y; /*< Flow in y-sensor direction, angular-speed compensated*/
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_CRC 155
#define MAVLINK_MSG_ID_100_CRC 155
...
#define MAVLINK_MESSAGE_INFO_OPTICAL_FLOW { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_optical_flow_t, time_usec) }, \
         { "flow_comp_x", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_optical_flow_t, flow_comp_x) }, \
         { "flow_comp_y", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_optical_flow_t, flow_comp_y) }, \
         ...
         { "flow_x", NULL, MAVLINK_TYPE_INT16_T, 0, 28, offsetof(mavlink_optical_flow_t, flow_x) }, \
         { "flow_y", NULL, MAVLINK_TYPE_INT16_T, 0, 30, offsetof(mavlink_optical_flow_t, flow_y) }, \
         { "sensor_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_optical_flow_t, sensor_id) }, \
         { "quality", NULL, MAVLINK_TYPE_UINT8_T, 0, 33, offsetof(mavlink_optical_flow_t, quality) }, \
         } \
}
 ...
 * @param flow_comp_x Flow in x-sensor direction, angular-speed compensated
 * @param flow_comp_y Flow in y-sensor direction, angular-speed compensated
...
static inline uint16_t mavlink_msg_optical_flow_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float flow_comp_x, float flow_comp_y, float flow_comp_m_x, float flow_comp_m_y, uint8_t quality, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_OPTICAL_FLOW_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
	_mav_put_float(buf, 8, flow_comp_x);
	_mav_put_float(buf, 12, flow_comp_y);
	...
	_mav_put_int16_t(buf, 30, flow_y);
	_mav_put_uint8_t(buf, 32, sensor_id);
	_mav_put_uint8_t(buf, 33, quality);

        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_OPTICAL_FLOW_LEN);
#else
	mavlink_optical_flow_t packet;
	packet.time_usec = time_usec;
	packet.flow_comp_x = flow_comp_x;
	packet.flow_comp_y = flow_comp_y;
...
{
	return mavlink_msg_optical_flow_pack(system_id, component_id, msg, optical_flow->time_usec, optical_flow->sensor_id, optical_flow->flow_x, optical_flow->flow_y, optical_flow->flow_comp_x, optical_flow->flow_comp_y, optical_flow->flow_comp_m_x, optical_flow->flow_comp_m_y, optical_flow->quality, optical_flow->ground_distance);
}
...
static inline void mavlink_msg_optical_flow_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float flow_comp_x, float flow_comp_y, float flow_comp_m_x, float flow_comp_m_y, uint8_t quality, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_OPTICAL_FLOW_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_optical_flow_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float flow_comp_x, float flow_comp_y, float flow_comp_m_x, float flow_comp_m_y, uint8_t quality, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field flow_comp_x from optical_flow message
 *
 * @return Flow in x-sensor direction, angular-speed compensated
 */
static inline float mavlink_msg_optical_flow_get_flow_comp_x(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field flow_comp_y from optical_flow message
 *
 * @return Flow in y-sensor direction, angular-speed compensated
 */
static inline float mavlink_msg_optical_flow_get_flow_comp_y(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_optical_flow_decode(const mavlink_message_t* msg, mavlink_optical_flow_t* optical_flow)
{
	...
	optical_flow->flow_comp_x = mavlink_msg_optical_flow_get_flow_comp_x(msg);
	optical_flow->flow_comp_y = mavlink_msg_optical_flow_get_flow_comp_y(msg);
